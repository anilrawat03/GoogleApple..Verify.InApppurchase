...
namespace VerifyInAppPurchase.Models
{
    ...
    /// </summary>
    /// <param name="AdamId">See <see cref="VerifyInAppPurchase.Models.Receipt.AppItemId"/>.</param>
    ...
    /// and corresponds to the value of <i>CFBundleVersion</i> (in iOS) or <i>CFBundleShortVersionString</i> (in macOS) in the <i>Info.plist</i> file of the original purchase. In the sandbox environment, the value is always "1.0".</param>
